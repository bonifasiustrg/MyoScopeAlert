...
data class PickerConfig(
    ...
    val cameraIcon: Int = R.drawable.ic_camera,
    ...
    val doneIcon: Int = R.drawable.ic_tick,
    ...
    val storageIcon: Int = R.drawable.ic_storage,
    ...
    val galleryIcon: Int = R.drawable.ic_gallery,
...
data class PickerMode(
    ...
    val itemIcon: Int = R.drawable.ic_music,
...
//        PickerType.File -> R.drawable.mahdiasd_ic_file
        PickerType.Audio -> R.drawable.ic_play
    }
}
